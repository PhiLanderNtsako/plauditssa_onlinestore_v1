      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="winter_collection.php">Winter</a></li>
          ...
          <div class="col-md-3">
            <div class="list-group">
              ...
              <?php
                  ...
                  $orders = $row8[0];
              ?>
              <a href="orders.php" class="list-group-item"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Orders <span class="badge"><?php echo $orders ?></span></a>            </div>
          </div>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Winter Collection</h3>
              </div>
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      <?php
                        ...
                        $sql="SELECT * FROM products, product_size WHERE products.product_category = 'Hoodie' AND product_size.productID = products.productID ORDER BY products.productID DESC";
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php echo $row['product_size_2XL'] ?>: <?php echo $row['product_quantity_2XL'] ?><br>
                          <?php echo $row['product_size_3XL'] ?>: <?php echo $row['product_quantity_3XL'] ?>
                        </td>
                      </tr>
                      <?php 
                        }
