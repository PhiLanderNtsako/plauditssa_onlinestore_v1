...
<html lang="en">
  <head>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="Kids_collection.php">Kids</a></li>
          ...
          <div class="col-md-2">
            <div class="dropdown create">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                <li><a type="button" data-toggle="modal" data-target="#addKidsColl">Add Kids Collection</a></li>
              </ul>
            </div>
          </div>          
        </div>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Kids Collection</h3>
              </div>
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      <?php
                        ...
                        $sql="SELECT * FROM products WHERE product_type = 'kids-collection' ORDER BY productID DESC";
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          Type: <?php echo $row['product_category'] ?>
                          <br>
                          <?php echo $row['product_date'] ?>
                        </td>
                        <td>
                          Price: R<?php echo $row['product_price'] ?><br> 
                          <?php echo $row['product_size_XS'] ?>: <?php echo $row['product_quantity_XS'] ?> |
                          <?php echo $row['product_size_S'] ?>: <?php echo $row['product_quantity_S'] ?><br>
                          <?php echo $row['product_size_M'] ?>: <?php echo $row['product_quantity_M'] ?> |
                          <?php echo $row['product_size_L'] ?>: <?php echo $row['product_quantity_L'] ?><br>
                          <?php echo $row['product_size_XL'] ?>: <?php echo $row['product_quantity_XL'] ?> |
                          <?php echo $row['product_size_XXL'] ?>: <?php echo $row['product_quantity_XXL'] ?><br>
                          <?php echo $row['product_size_XXXL'] ?>: <?php echo $row['product_quantity_XXXL'] ?>
                        </td>
                        <td>
    ...
    <!-- Add Page -->
    <div class="modal fade" id="addKidsColl" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add Kids Collection</h4>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="category" required="true">
              ...
              <option value="Golf Shirt">Golf Shirt</option>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">Add Kids Collection</button>
      </div>
    </form>
    </div>
  </div>
