...
<html lang="en">
  <head>
   ...
   <body>
          ...
          <div class="col-md-2">
            <div class="dropdown create">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                <li><a type="button" data-toggle="modal" data-target="#addTShirts">Add T-Shirts</a></li>
              </ul>
            </div>
          </div>
        </div>
              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      <?php
                        ...
                        $sql="SELECT * FROM products, product_size WHERE products.product_type = 't-shirts' AND product_size.productID = products.productID ORDER BY products.productID DESC";
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-default" href="edit_tshirts.php?id1=<?php echo $row['productID'] ?>&id2=<?php echo $row['productSizeID'] ?>">EDIT</a>
                        </td>
                      </tr>
                      <?php 
                        }
    ...
    <!-- Add Page -->
    <div class="modal fade" id="addTShirts" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add T-Shirts</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">Add T-Shirt</button>
      </div>
    </form>
    </div>
  </div>
