      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="pride_merch.php">Pride-Merch</a></li>
          ...
          <div class="col-md-2">
            <div class="dropdown create">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                <li><a type="button" data-toggle="modal" data-target="#addKidsColl">Add Pride Merch</a></li>
              </ul>
            </div>
          </div>          
        </div>
              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      <?php
                        ...
                        $sql="SELECT * FROM products WHERE product_category = 'Pride Merch' ORDER BY productID DESC";
