...
<html lang="en">
  ...
  <body>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <?php
                  $sql9="SELECT count(1) FROM products"; $result=mysqli_query($conn,$sql9); $row9 = mysqli_fetch_array($result);
                  $products = $row9[0];
                ?>
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-tags" aria-hidden="true"></span> <?php echo $products ?></h2>
                    <h4>Products</h4>
                  </div>
                </div>

                <?php
                  $sql10="SELECT count(1) FROM users"; $result=mysqli_query($conn,$sql10); $row10 = mysqli_fetch_array($result);
                  $users = $row10[0];
                ?>
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-user" aria-hidden="true"></span> <?php echo $users ?></h2>
                    <a href="users.php"><h4>Users</h4></a> 
                  </div>
                </div>

                <?php
                  $sql11="SELECT count(1) FROM pre_orders"; $result=mysqli_query($conn,$sql11); $row11 = mysqli_fetch_array($result);
                  $orders = $row11[0];
                ?>
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> <?php echo $orders ?></h2>
                    <a href="orders.php"><h4>Orders</h4></a> 
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-check" aria-hidden="true"></span></h2>
                    <a href="referrals/referral_thapelo.php"><h4>Referrals</h4></a> 
                  </div>
                </div>
              </div>
            </div>
    ...
    <footer id="footer">
      <p>&copy;<script>document.write(new Date().getFullYear());</script> Sweet Sound Tech</a></p>
    </footer>
