  ...
  <head>
   ...
   <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="referrals/referral_thapelo.php">Thapelo</a></li>
            ...
            <li><a href="referrals/referral_thabo.php">Thabo</a></li>
            <li class="active"><a href="referrals/referral_siyabonga.php">Siyabonga</a></li>
    ...
    <section id="breadcrumb">
      <div class="container">
        <ol class="breadcrumb">
          <li class="active">Referrals - Siyabonga</li>
        </ol>
      </div>
    </section>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Code: siyabonga</h3>
              </div>
              <div class="panel-body"><br>
                <table class="table table-striped table-hover">
                  ...
                  <?php
                        ...
                        $sql="SELECT * FROM users INNER JOIN pre_orders ON users.userID = pre_orders.userID INNER JOIN post_orders ON post_orders.preOrderID = pre_orders.preOrderID WHERE post_orders.referral_code = 'siyabonga'";
                        $result_set=mysqli_query($conn,$sql);
                        $bonus_total = 0;
                  ...
                  ?>
                    ...
                    <table class="table table-striped table-hover">
                      <tr>
                        <th>Total Recouped 
                          <?php 
                            $sql="SELECT * FROM users, orders, post_orders WHERE post_orders.referral_code = 'siyabonga'";
                            $result_set=mysqli_query($conn,$sql);
                            $row=mysqli_fetch_array($result_set);
...
<script language="javascript" type="text/javascript">
  function confirmDelete() {
    if (confirm('Are You Sure Referrals To Siyabonga Are Paid?')) {
      return true;
    }
    return false;
  } 
