          ...
          <div class="col-md-2">
            <div class="dropdown create">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                <li><a type="button" data-toggle="modal" data-target="#addArtist">Edit Headwear</a></li>
              </ul>
            </div>
          </div>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <a href="headwear.php"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></a>
        <h4 class="modal-title" id="myModalLabel">Edit Headwear</h4>
      </div>
     <div class="modal-body">
        <div class="form-group">
          ...
          <input type="hidden" name="xsmall_quantity" class="form-control" value="">
          <input type="hidden" name="small_quantity" class="form-control" value="">
          <input type="hidden" name="medium_quantity" class="form-control" value="">
          <input type="hidden" name="large_quantity" class="form-control" value="">
          <input type="hidden" name="xlarge_quantity" class="form-control" value="">
          <input type="hidden" name="2xlarge_quantity" class="form-control" value="">
          <input type="hidden" name="3xlarge_quantity" class="form-control" value="">
          <input type="number" name="oneSize_quantity" class="form-control" min="0" required="true" value="<?php echo $row2['product_quantity_oneSize'] ?>">
        </div>
      </div>
      <div class="modal-footer">
        <a href="headwear.php"><button type="button" class="btn btn-danger" data-dismiss="modal">Close</button></a>
        <button type="submit" class="btn btn-primary">Edit Headwear</button>
      </div>
    </form>
    </div>
  </div>
