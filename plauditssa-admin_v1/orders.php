              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php
                          ...
                          $sql="SELECT * FROM pre_orders, users WHERE pre_orders.userID = users.userID ORDER BY pre_orders.preOrderID DESC";
                    ...
                    ?>
                      <tr>
                        <td><?php echo $row['user_firstName'] ?>
                          <?php echo $row['user_lastName'] ?><br>
                          <?php echo $row['user_phone'] ?><br>
                          <?php echo $row['user_email'] ?>
                      </td>
                        <td>
                          <?php echo $row['user_streetAddress'] ?>, <?php echo $row['user_suburb'] ?><br>
                          <?php echo $row['user_towncity'] ?>, <?php echo $row['user_zipcode'] ?><br>
                          <?php echo $row['user_province'] ?>
                        </td>
                        <td><strong>
                          <?php echo $row['preOrder_date'] ?>           
                        </td></strong>
                        <td>
                          <strong>PLDTS#<?php echo $row['preOrderID'] ?></strong>
                        </td>
                        <td>
