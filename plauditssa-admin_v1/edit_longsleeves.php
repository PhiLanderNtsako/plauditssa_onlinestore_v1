          ...
          <div class="col-md-2">
            <div class="dropdown create">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                <li><a type="button" data-toggle="modal" data-target="#addArtist">Edit Long Sleeves</a></li>
              </ul>
            </div>
          </div>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <a href="long_sleeves.php"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></a>
        <h4 class="modal-title" id="myModalLabel">Edit Long Sleeves</h4>
      </div>
      ...
      <div class="modal-footer">
        <a href="long_sleeves.php"><button type="button" class="btn btn-danger" data-dismiss="modal">Close</button></a>
        <button type="submit" class="btn btn-primary">Edit Long Sleeves</button>
      </div>
    </form>
    </div>
  </div>
