...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="hoodies.php">Hoodies</a></li>
          ...
          <div class="col-md-2">
            <div class="dropdown create">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                <li><a type="button" data-toggle="modal" data-target="#addHoodies">Add Hoodies</a></li>
              </ul>
            </div>
          </div>          
        </div>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Hoodies</h3>
              </div>
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      <?php
                        ...
                        $sql="SELECT * FROM products, product_size WHERE products.product_type = 'hoodies' AND product_size.productID = products.productID ORDER BY products.productID DESC";
    ...
    <!-- Add Page -->
    <div class="modal fade" id="addHoodies" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add Hoodie</h4>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group">
          <label>Title</label>
          <input type="text" name="title" class="form-control" required="true" placeholder="e.g Orange Plaudits SA Hoodie">
        </div>
        <div class="form-group">
          <label>Title Slug</label>
          <input type="text" name="titleSlug" class="form-control" required="true" placeholder="e.g orange-plaudits-sa-hoodie">
        </div>
        <div class="form-group">
          <label>Price</label>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">Add Hoodie</button>
      </div>
    </form>
    </div>
  </div>
