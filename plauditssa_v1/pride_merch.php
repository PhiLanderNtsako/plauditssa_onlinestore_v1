...
<head>
  ...
  <title>Plaudits SA - Pride Merch</title>
...
<!-- Menu -->
<div class="menu"  style="background-image: url(images/plaudits/models/model19.jpg);">
  ...
  <div class="menu_nav">
    <ul>
      ...
      <li class="active"><a href="pride-merch/">Pride Merch</a></li>
...
<div class="super_container">
  ...
  <div class="super_container_inner">
    ...
    <!-- Home -->
    <div class="home" style="background-image: url(images/plaudits/models/model20.jpg);">
      <div class="home_container d-flex flex-column align-items-center justify-content-end">
        <div class="home_content text-center">
          <div class="home_title" style="color: mediumseagreen">Pride Merch</div>
