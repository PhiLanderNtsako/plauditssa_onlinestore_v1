...
<head>
	...
	<title>Plaudits SA - Winter Collection</title>
...
<!-- Menu -->
<div class="menu"  style="background-image: url(images/plaudits/models/model17.jpg);">
	...
	<div class="menu_nav">
		<ul>
			...
			<li class="active"><a href="winter-collection/">Winter Collection</a></li>
...
<div class="super_container">
	...
	<div class="super_container_inner">
		...
		<!-- Home -->
		<div class="home" style="background-image: url(images/plaudits/models/model16.jpg);">
			<div class="home_container d-flex flex-column align-items-center justify-content-end">
				<div class="home_content text-center">
					<div class="home_title" style="color: mediumseagreen">Winter Collection</div>
		...
		<div class="products">
			<div class="container">
					...
					<div class="col">
						<div class="products_bar d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-center justify-content-center">
							<div class="products_bar_links" style="color: mediumseagreen">
								<ul class="d-flex flex-row align-items-start justify-content-start">
									<li><a href="winter-collection/">Hoodies</a></li>
									<li><a href="winter-collection/">Sweaters</a></li>
									<li><a href="winter-collection/">Beanies</a></li>
									<li><a href="winter-collection/">Scarfs</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="row products_row products_container grid">
					<?php
                        $sql="SELECT * FROM products WHERE product_type = 'Hoodies' OR product_category = 'Sweater' OR product_category = 'Beanie' ORDER BY productID DESC";
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									...
									<div class="ml-auto text-right">
										<div class="rating_r rating_r_4 home_item_rating">In <a href="<?php echo $row['product_type'] ?>/"><?php echo $row['product_type'] ?></a></div>
