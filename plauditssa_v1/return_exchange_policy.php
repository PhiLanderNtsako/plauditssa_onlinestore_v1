...
<head>
	...
	<title>Plaudits SA - Return & Exchange Policy</title>
		...
		<div class="home" style="background-image: url(images/plaudits/model8.jpg);">
			<div class="home_container d-flex flex-column align-items-center justify-content-end">
				<div class="home_content text-center">
					<div class="home_title">Return and Exchange Policy</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-6 cart_col">
						<div class="cart_total">
							<div class="cart_extra_content cart_extra_total">
								<div class="checkout_title">Return And Exchange Policy</div><br>
								<p>Plaudits SA Clothing will accept the return or exchange of items that are still in new condition, unworn, unaltered and free from damages and dirt by the customers.</p>
								<p>For full refund or exchange, return or mail out the item within 14 days from date of purhcase with proof of payment inside the package and contact us, notifying us with the returning of the product and when to expect it.</p>
								<p>All items must be returned with all Plaudits SA Clothing tags if any and must be in their original packaging the product came with</p>
							</div>
						</div>
					</div>
					<!-- Cart Total -->
					<div class="col-lg-6 cart_col">
						<div class="cart_total">
							<div class="cart_extra_content cart_extra_total">
								<div class="checkout_title">Return or Exchange Product</div>
								<div class="checkout_form_container">
									<form action="process/support.php" method="post" id="checkout_form" class="checkout_form">
										...
										<div>
											<!-- Email -->
											<input type="email" name="firstName" name="email" id="email" class="checkout_input" placeholder="Email" required="required">
										</div>
										<div>
											<!-- Email -->
