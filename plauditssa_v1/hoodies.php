...
<head>
	...
	<title>Plaudits SA - Hoodies</title>
...
<div class="menu"  style="background-image: url(images/plaudits/models/model17.jpg);">
	...
	<div class="menu_nav">
		<ul>
			...
			<li class="active"><a href="hoodies/">Hoodies</a></li>
...
<div class="super_container">
	...
	<div class="super_container_inner">
		...
		<!-- Home -->
		<div class="home" style="background-image: url(images/plaudits/models/model13.jpg);">
			<div class="home_container d-flex flex-column align-items-center justify-content-end">
				<div class="home_content text-center">
					<div class="home_title" style="color: mediumseagreen">Hoodies</div>
		...
		<div class="products">
			<div class="container">
				<div class="row products_row products_container grid">
					<?php
                        $sql="SELECT * FROM products WHERE product_type = 'Hoodies' ORDER BY productID DESC";
