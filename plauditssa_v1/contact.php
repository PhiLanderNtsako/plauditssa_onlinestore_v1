...
<head>
	...
	<title>Plaudits SA - Contact Us</title>
	<base href="https://plauditssa.co.za/">
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="description" content=" Email: plauditssa@gmail.com | Phone: +27 84 970 6769 | Plaudits SA it's a clothing brand which expresses enthusiasms and it let's everyone to know that it's important to reach out to opportunities. The name was derived from the word 'Applause'.">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-6 cart_col">
						<div class="cart_total">
							<div class="cart_extra_content cart_extra_total">
								<div class="checkout_title">Contact Info</div><br>
								<ul class="cart_extra_total_list">
									<li class="d-flex flex-row align-items-center justify-content-start">
										<div class="cart_extra_total_title"><i class="fa fa-map-marker"></i> </div>
										<div class="cart_extra_total_value ml-auto">11011 Makena Street</div>
									</li>
									<li class="d-flex flex-row align-items-center justify-content-start">
										<div class="cart_extra_total_title"><i class="fa fa-map-marker"></i> </div>
										<div class="cart_extra_total_value ml-auto">Mamelodi East</div>
									</li>
									<li class="d-flex flex-row align-items-center justify-content-start">
										<div class="cart_extra_total_title"><i class="fa fa-map-marker"></i> </div>
										<div class="cart_extra_total_value ml-auto">Pretoria, 0122</div>
									</li>
									<li class="d-flex flex-row align-items-center justify-content-start">
										<div class="cart_extra_total_title"><i class="fa fa-phone-square"></i></div>
										<div class="cart_extra_total_value ml-auto">+27 84 970 6769</div>
									</li>
									<li class="d-flex flex-row align-items-center justify-content-start">
										<div class="cart_extra_total_title"><i class="fa fa-envelope"></i></div>
										<div class="cart_extra_total_value ml-auto">info@plauditssa.co.za</div>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="col-lg-6 cart_col">
						<div class="cart_total">
							<div class="cart_extra_content cart_extra_total">
								<div class="checkout_title">Send A Message</div>
